...
<form action = "{{ route('bb.store') }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input name="title" id="textTitle" class="form-control">
    </div>
    <div class="mb-3">
        <label for="txtContent" class="form-label">Описание</label>
        <textarea name="content" id="textContent" class="form-control" row="3"></textarea>
    </div>
    <div class="mb-3">
        <label for="txtPrice" class="form-label">Цена</label>
        <input name="price" id="textPrice" class="form-control">
    </div>
